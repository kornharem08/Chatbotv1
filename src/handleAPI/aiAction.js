...
const handleApiAiAction = async (
  ...
  switch (action) {
    ...
    case "send-carousel":
      const elements = [
        fb.carouselTemplate("Welcome!","https://www.computing.psu.ac.th/th/wp-content/uploads/2018/03/PSU_CoC_ENG.png","We have the right hat for everyone.",
        fb.buttonsURL(urlweb.sisurl,"View Website"),
        fb.buttonsURL(urlweb.sisurl,"Schedule"),
        fb.buttonsURL(urlweb.sisurl,"Test")),
