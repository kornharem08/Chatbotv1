...
const messageExSc = async (sender) => {
  ...
  let replies = fb.quickreplyTemplate("Please select Semester/Year criteria", [fb.quickreply("<< Back", "test", null), fb.quickreply("1/2559", {type:"EX",year:"1/2559"}, null), fb.quickreply("2/2559", "Ex_2/2559", null), fb.quickreply("3/2559", "Ex_3/2559", null)])
  await sendQuickReply(sender, replies);
