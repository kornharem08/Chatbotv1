...
const quickreplyGradeGPAsemester = async (sender) => {
  ...
  let txt_lang = await api.requestLang(sender)
  let replies = fb.quickreplyTemplate(Dict.semester_TXT[txt_lang], [fb.quickreply(Dict.back_TXT[txt_lang], '{"campagin":"MainMenu_Payload","data":"null"}', null),fb.quickreply("1/2561", '{"campagin":"Grade_Semester_quickreply","data":"2/2561"}',null),fb.quickreply("1/2560", '{"campagin":"Grade_Semester_quickreply","data":"2/2560"}', null),fb.quickreply("1/2559", '{"campagin":"Grade_Semester_quickreply","data":"2/2559"}', null)])
...
const btnGradeGPAViewall = async (sender) => {
  let txt_lang = await api.requestLang(sender)
  let studentID = await api.requestStudentID(sender)
  let btnMessage = await fb.buttonsTemplate(Dict.view_Grade_TXT[txt_lang], [fb.buttonsURL(`${urlweb.sisurl_grade_all}/${studentID}/0/0`, Dict.click_toview_TXT[txt_lang]), fb.buttons(Dict.back_TXT[txt_lang], "MainMenu_Payload")])
  await sendBtnMessage(sender, btnMessage)
